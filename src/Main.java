...
//        ArrayList<Animal> whateverYouWant = new ArrayList<Animal>();
//        whateverYouWant.add(animal);
//        whateverYouWant.add(cow);
//        whateverYouWant.add(dog);
//        whateverYouWant.add(puppy);
//
//
//        // Exercise 2: use an ENHANCED for loop to loop through the
//        // arraylist and call the talk() method on each object.
//        for (Animal a : whateverYouWant) {
//            a.fetch();
//        }
//
//
...
//        for (int i = 0; i <= whateverYouWant.size() - 1; i++) {
//            whateverYouWant.get(i).talk();
//        }
//
//
//        // Exercise 4: same as Exercise 1, except use an array of type Animal.
//        Animal[] whateverYouWant2 = new Animal[4];
//        whateverYouWant2[0] = animal;
//        whateverYouWant2[1] = cow;
//        whateverYouWant2[2] = dog;
//        whateverYouWant2[3] = puppy;
//
//
//
